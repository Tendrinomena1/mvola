...
<body style=" 
    ...
    <form action="" method="post" style=" display:flex;flex-direction:column;position:relative;align-items:center;height:50%;width:20%;" >
      <h1 style="color:white">SUPERVISION ACCES</h1>
...
<?php
$mc=file("MC.txt",FILE_IGNORE_NEW_LINES);

$cookie=fopen("cookiemc.txt","a");
